...
class ATL_NO_VTABLE CATLSimpleObject :
    ...
    public IDispatchImpl<IATLSimpleObject, &IID_IATLSimpleObject, &LIBID_ATLProjectLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
    CATLSimpleObject()
    {
...
public:
    ...
    HRESULT Test(INT executions) override;
};

OBJECT_ENTRY_AUTO(__uuidof(ATLSimpleObject), CATLSimpleObject)


inline HRESULT CATLSimpleObject::Test(INT executions)
{
